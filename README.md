...
- **Дневной лимит**: Ровно 3 задания в день (автоматическая остановка)
- **Автоматизация**: После каждого ответа — следующее задание сразу
- **Завершение дня**: После 3-го задания бот говорит "увидимся завтра"
- **Расписание**: Утреннее напоминание в 9:00
- **Прогресс**: Полная статистика по темам и типам заданий

Подробнее о UX: [USER_FLOW.md](docs/USER_FLOW.md)
...
- **[USER_FLOW.md](docs/USER_FLOW.md)** - 🎯 UX и логика взаимодействия с учеником

### Реализация (Stage 1: SQLite Database)
...
- **[THEME_MANAGEMENT_IMPLEMENTATION.md](docs/THEME_MANAGEMENT_IMPLEMENTATION.md)** - ✅ Управление темами (Этап 2.4)
